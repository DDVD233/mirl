...
class RayPPOTrainer:
    ...
    def _save_checkpoint(self):
        ...
        # save EMA stats (task_stats and dataset_stats)
        save_ema_stats(local_global_step_folder)
    ...
    def _load_checkpoint(self):
        ...
        # load EMA stats (task_stats and dataset_stats)
        load_ema_stats(global_step_folder)
    ...
    def _harpo_metrics_all(self):
        ...
        for task_id, st in core_algos.task_stats.items():
            ...
            out[f"{prefix}/mixture_density_log_mult_ema_scale"]  = float(st.get("mixture_log_mult_ema_scale", 0.0))
