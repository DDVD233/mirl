...
class RayPPOTrainer:
    ...
    def _tarpo_metrics_all(self):
        ...
        for task_id, st in core_algos.task_stats.items():
            ...
            # --- Post-GRPO advantages (after group normalization) ---
            out[f"{prefix}/post_grpo_advantage_batch_mu"]         = float(st.get("post_grpo_advantage_batch_mu", 0.0))
            out[f"{prefix}/post_grpo_advantage_batch_sigma"]      = float(st.get("post_grpo_advantage_batch_sigma", 1.0))
            out[f"{prefix}/post_grpo_advantage_batch_abs_mean"]   = float(st.get("post_grpo_advantage_batch_abs_mean", 0.0))
            out[f"{prefix}/post_grpo_advantage_batch_abs_sigma"]  = float(st.get("post_grpo_advantage_batch_abs_sigma", 1.0))
            out[f"{prefix}/post_grpo_advantage_batch_frac_pos"]   = float(st.get("post_grpo_advantage_batch_frac_pos", 0.0))
            out[f"{prefix}/post_grpo_advantage_batch_frac_neg"]   = float(st.get("post_grpo_advantage_batch_frac_neg", 0.0))
            out[f"{prefix}/post_grpo_advantage_batch_skewness"]   = float(st.get("post_grpo_advantage_batch_skewness", 0.0))
            out[f"{prefix}/post_grpo_advantage_batch_p10"]        = float(st.get("post_grpo_advantage_batch_p10", 0.0))
            out[f"{prefix}/post_grpo_advantage_batch_p50"]        = float(st.get("post_grpo_advantage_batch_p50", 0.0))
            out[f"{prefix}/post_grpo_advantage_batch_p90"]        = float(st.get("post_grpo_advantage_batch_p90", 0.0))
            out[f"{prefix}/post_grpo_advantage_ema_mu"]           = float(st.get("post_grpo_advantage_ema_mu", 0.0))
            out[f"{prefix}/post_grpo_advantage_ema_sigma"]        = float(st.get("post_grpo_advantage_ema_sigma", 1.0))
            out[f"{prefix}/post_grpo_advantage_ema_abs_mean"]     = float(st.get("post_grpo_advantage_ema_abs_mean", 0.0))
            out[f"{prefix}/post_grpo_advantage_ema_abs_sigma"]    = float(st.get("post_grpo_advantage_ema_abs_sigma", 1.0))
            out[f"{prefix}/post_grpo_advantage_ema_frac_pos"]     = float(st.get("post_grpo_advantage_ema_frac_pos", 0.0))
            out[f"{prefix}/post_grpo_advantage_ema_frac_neg"]     = float(st.get("post_grpo_advantage_ema_frac_neg", 0.0))
            out[f"{prefix}/post_grpo_advantage_ema_skewness"]     = float(st.get("post_grpo_advantage_ema_skewness", 0.0))
            ...
            out[f"{prefix}/mixture_density_rho_batch"]       = float(st.get("mixture_rho_t_batch", 0.0))
            out[f"{prefix}/mixture_density_rho_ema"]         = float(st.get("mixture_rho_t_ema", 0.0))
            ...
            out[f"{prefix}/mixture_density_log_rarity_pos"]  = float(st.get("mixture_log_rarity_pos", 0.0))
            ...
            out[f"{prefix}/mixture_density_log_ratio"]       = float(st.get("mixture_log_ratio_scale", 0.0))
            out[f"{prefix}/mixture_density_log_mult_inst"]   = float(st.get("mixture_log_mult_inst_scale", 0.0))
            out[f"{prefix}/mixture_density_log_mult_ema"]    = float(st.get("mixture_log_mult_ema_scale", 0.0))
            ...
            out[f"{prefix}/final_advantage_batch_abs_sigma"]  = float(st.get("final_advantage_batch_abs_sigma", 1.0))
            out[f"{prefix}/final_advantage_batch_frac_pos"]   = float(st.get("final_advantage_batch_frac_pos", 0.0))
            out[f"{prefix}/final_advantage_batch_frac_neg"]   = float(st.get("final_advantage_batch_frac_neg", 0.0))
            out[f"{prefix}/final_advantage_batch_skewness"]   = float(st.get("final_advantage_batch_skewness", 0.0))
            out[f"{prefix}/final_advantage_batch_p10"]        = float(st.get("final_advantage_batch_p10", 0.0))
            out[f"{prefix}/final_advantage_batch_p50"]        = float(st.get("final_advantage_batch_p50", 0.0))
            out[f"{prefix}/final_advantage_batch_p90"]        = float(st.get("final_advantage_batch_p90", 0.0))
            ...
            out[f"{prefix}/final_advantage_ema_abs_mean"]     = float(st.get("final_advantage_ema_abs_mean", 0.0))
            out[f"{prefix}/final_advantage_ema_abs_sigma"]    = float(st.get("final_advantage_ema_abs_sigma", 1.0))
            out[f"{prefix}/final_advantage_ema_frac_pos"]     = float(st.get("final_advantage_ema_frac_pos", 0.0))
            out[f"{prefix}/final_advantage_ema_frac_neg"]     = float(st.get("final_advantage_ema_frac_neg", 0.0))
            out[f"{prefix}/final_advantage_ema_skewness"]     = float(st.get("final_advantage_ema_skewness", 0.0))
            out[f"{prefix}/final_advantage_ema_p10"]          = float(st.get("final_advantage_ema_p10", 0.0))
            out[f"{prefix}/final_advantage_ema_p50"]          = float(st.get("final_advantage_ema_p50", 0.0))
            out[f"{prefix}/final_advantage_ema_p90"]          = float(st.get("final_advantage_ema_p90", 0.0))
            ...
            out[f"{prefix}/adapter_mu_scale"]    = float(st.get("adapter_mu_scale", 1.0))
            out[f"{prefix}/adapter_sigma_scale"] = float(st.get("adapter_sigma_scale", 1.0))
            out[f"{prefix}/adapter_final_scale"] = float(st.get("adapter_final_scale", 1.0))
