...
class RayPPOTrainer:
    ...
    def _tarpo_metrics_all(self):
        ...
        for task_id, st in core_algos.task_stats.items():
            ...
            out[f"{prefix}/post_grpo_batch_mu"]         = float(st.get("post_grpo_batch_mu", 0.0))
            out[f"{prefix}/post_grpo_batch_sigma"]      = float(st.get("post_grpo_batch_sigma", 1.0))
            out[f"{prefix}/post_grpo_batch_abs_mean"]   = float(st.get("post_grpo_batch_abs_mean", 0.0))
            out[f"{prefix}/post_grpo_batch_frac_pos"]   = float(st.get("post_grpo_batch_frac_pos", 0.0))
            out[f"{prefix}/post_grpo_batch_frac_neg"]   = float(st.get("post_grpo_batch_frac_neg", 0.0))
            out[f"{prefix}/post_grpo_batch_skewness"]   = float(st.get("post_grpo_batch_skewness", 0.0))
            out[f"{prefix}/post_grpo_batch_p10"]        = float(st.get("post_grpo_batch_p10", 0.0))
            out[f"{prefix}/post_grpo_batch_p50"]        = float(st.get("post_grpo_batch_p50", 0.0))
            out[f"{prefix}/post_grpo_batch_p90"]        = float(st.get("post_grpo_batch_p90", 0.0))
            out[f"{prefix}/post_grpo_ema_mu"]           = float(st.get("post_grpo_ema_mu", 0.0))
            out[f"{prefix}/post_grpo_ema_sigma"]        = float(st.get("post_grpo_ema_sigma", 1.0))
            out[f"{prefix}/post_grpo_ema_abs_mean"]     = float(st.get("post_grpo_ema_abs_mean", 0.0))
            out[f"{prefix}/post_grpo_ema_frac_pos"]     = float(st.get("post_grpo_ema_frac_pos", 0.0))
            out[f"{prefix}/post_grpo_ema_frac_neg"]     = float(st.get("post_grpo_ema_frac_neg", 0.0))
            out[f"{prefix}/post_grpo_ema_skewness"]     = float(st.get("post_grpo_ema_skewness", 0.0))
            out[f"{prefix}/post_grpo_ema_p10"]          = float(st.get("post_grpo_ema_p10", 0.0))
            out[f"{prefix}/post_grpo_ema_p50"]          = float(st.get("post_grpo_ema_p50", 0.0))
            out[f"{prefix}/post_grpo_ema_p90"]          = float(st.get("post_grpo_ema_p90", 0.0))
