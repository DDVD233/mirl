...
export NCCL_ASYNC_ERROR_HANDLING=1
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='v2_emagrpo_engaging_baseline' \
        trainer.n_gpus_per_node=2 \
        trainer.nnodes=1 \
        trainer.save_freq=50 \
        trainer.val_before_train=False \
        trainer.val_only=False \
        trainer.validation_data_dir=/scratch/keane/human_behaviour/v2_emagrpo_engaging_baseline \
        trainer.test_freq=99999 \
        trainer.total_epochs=5 \
        trainer.advantage_save_dir=/scratch/keane/human_behaviour/v2_emagrpo_engaging_baseline/advantages \
        trainer.advantage_plot_freq=15 $@ \
        trainer.default_local_dir=/scratch/keane/human_behaviour/v2_emagrpo_engaging_baseline
