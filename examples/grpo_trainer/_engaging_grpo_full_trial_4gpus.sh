...
export TORCH_USE_CUDA_DSA=1
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='grpo_engaging_baseline_4_gpus' \
        trainer.n_gpus_per_node=4 \
        trainer.nnodes=1 \
        trainer.save_freq=25 \
        trainer.val_before_train=False \
        trainer.val_only=False \
        trainer.validation_data_dir=/scratch/keane/human_behaviour/grpo_engaging_baseline_4_gpus \
        trainer.test_freq=999999 \
        trainer.total_epochs=5 \
        trainer.advantage_save_dir=/scratch/keane/human_behaviour/grpo_engaging_baseline_4_gpus/advantages \
        trainer.advantage_plot_freq=15 $@ \
        trainer.default_local_dir=/scratch/keane/human_behaviour/grpo_engaging_baseline_4_gpus
