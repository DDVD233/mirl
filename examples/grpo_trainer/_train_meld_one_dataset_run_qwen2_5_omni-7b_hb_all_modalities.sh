...
PYTHONUNBUFFERED=1 HYDRA_FULL_ERROR=1 PYTHONPATH="/home/keaneong/human-behavior/verl:$PYTHONPATH" NCCL_ASYNC_ERROR_HANDLING=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='add_audio_meld_hb_omni' \
    trainer.experiment_name='add_audio_meld_hb_omni ' \
    trainer.n_gpus_per_node=2 \
    trainer.nnodes=1 \
    trainer.save_freq=-1 \
    trainer.val_before_train=False \
    trainer.val_only=False \
    trainer.validation_data_dir=/home/keaneong/human-behavior/verl/examples/grpo_trainer/val_add_audio_meld_hb_omni \
    trainer.test_freq=2 \
    trainer.total_epochs=10 $@ \
    trainer.default_local_dir=/scratch/keane/human_behaviour/add_audio_meld_hb_omni \
