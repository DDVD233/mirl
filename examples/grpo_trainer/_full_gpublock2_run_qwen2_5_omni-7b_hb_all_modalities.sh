...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/scratch/keane/human_behaviour/human_behaviour_data/audio_sigs_fixed_full_train.jsonl \
    data.val_files=/scratch/keane/human_behaviour/human_behaviour_data/audio_sigs_fixed_full_val.jsonl \
    ...
    trainer.project_name='full_mixed_modal_verl_hb' \
    ...
    trainer.validation_data_dir=/home/keaneong/human-behavior/verl/examples/grpo_trainer/val_log_full_mixed_modal_verl_hb \
    trainer.test_freq=5 \
    trainer.total_epochs=5 $@ \
    trainer.default_local_dir=/scratch/keane/human_behaviour/full_mixed_modal_verl_hb