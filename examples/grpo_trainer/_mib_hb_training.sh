...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/scratch/keane/human_behaviour_data/w_feats_v6_exclude_heldout_train.jsonl \
    data.val_files=/scratch/keane/human_behaviour_data/w_feats_v6_exclude_heldout_val.jsonl \
    ...
    trainer.validation_data_dir=/scratch/keane/human_behaviour_data/rl_omni_heldout \
    trainer.test_freq=50 \
    trainer.total_epochs=5 $@ \
    trainer.default_local_dir=/scratch/keane/human_behaviour_data/rl_omni_heldout