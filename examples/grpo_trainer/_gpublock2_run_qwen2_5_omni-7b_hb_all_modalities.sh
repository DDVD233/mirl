...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='remove_expw_mixed_modal_verl_hb' \
    trainer.experiment_name='remove_expw_mixed_modal_omni_gpublock_2' \
    trainer.n_gpus_per_node=2 \
    trainer.nnodes=1 \
    trainer.save_freq=10 \
    trainer.val_before_train=False \
    trainer.val_only=False \
    trainer.validation_data_dir=/home/keaneong/human-behavior/verl/examples/grpo_trainer/2_val_log_remove_expw_hb_omni_gpublock2 \
    trainer.test_freq=5 \
    trainer.total_epochs=5 $@ \
    trainer.default_local_dir=/scratch/keane/human_behaviour/2_remove_expw_hb_omni_gpublock2