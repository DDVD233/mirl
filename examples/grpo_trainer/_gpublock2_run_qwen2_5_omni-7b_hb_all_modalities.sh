...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/scratch/keane/human_behaviour/human_behaviour_data/audio_sigs_no_expw_no_mosei_fixed_0.1_train.jsonl \
    data.val_files=/scratch/keane/human_behaviour/human_behaviour_data/audio_sigs_no_expw_no_mosei_fixed_0.1_val.jsonl \
    ...
    trainer.project_name='add_audio_remove_expw_remove_mosei_mixed_modal_verl_hb' \
    ...
    trainer.validation_data_dir=/home/keaneong/human-behavior/verl/examples/grpo_trainer/val_log_add_audio_remove_expw_remove_mosei_mixed_modal_verl_hb \
    trainer.test_freq=5 \
    trainer.total_epochs=5 $@ \
    trainer.default_local_dir=/scratch/keane/human_behaviour/add_audio_remove_expw_remove_mosei_mixed_modal_verl_hb