...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/home/jadali85/orcd/scratch/autism/ados_eval/global_text/ados_global_text_full_v2_train.jsonl \
    data.val_files=/home/jadali85/orcd/scratch/autism/ados_eval/global_text/ados_global_text_full_v2_val.jsonl \
    ...
    trainer.project_name='jada_GtM_VLmodel' \
    trainer.experiment_name='jada_GtM_summarized_VLmodel' \
    trainer.n_gpus_per_node=2 \
    trainer.nnodes=1 \
    trainer.save_freq=4 \
    trainer.val_before_train=True \
    trainer.val_only=False \
    trainer.validation_data_dir=/home/jadali85/orcd/scratch/autism/ados_eval/global_text/results_GtM_VL/ \
    trainer.test_freq=1 \
    trainer.total_epochs=4 $@ \
    trainer.default_local_dir=/home/jadali85/orcd/scratch/autism/ados_eval/global_text/results_GtM_VL/