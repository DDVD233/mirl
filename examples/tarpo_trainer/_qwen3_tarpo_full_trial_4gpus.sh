...
# rla_fulltemp_test_daicwoz.jsonl 
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='qwen3_vl' \
        trainer.n_gpus_per_node=4 \
        trainer.nnodes=1 \
        trainer.save_freq=10 \
        trainer.val_before_train=True \
        trainer.val_only=True \
        trainer.validation_data_dir=/scratch/keane/human_behaviour/qwen3_vl \
        trainer.test_freq=10 \
        trainer.total_epochs=5 \
        trainer.advantage_save_dir=/scratch/keane/human_behaviour/qwen3_vl/advantages \
        trainer.advantage_plot_freq=10 $@ \
        trainer.default_local_dir=/scratch/keane/human_behaviour/qwen3_vl