...
# trainer.resume_from_path=/scratch/keane/human_behaviour/harpo_unnormalized_adv/global_step_300
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        data.val_files=/scratch/keane/human_behaviour/human_behaviour_data/no_vid_test_processed_iemocap_ground_truth.jsonl \
        ...
        trainer.experiment_name='iemocap_harpo_unnormed' \
        ...
        trainer.validation_data_dir=/scratch/keane/human_behaviour/harpo_unnormalized_adv/global_step_300_iemocap_test \
        trainer.test_freq=1 \
        trainer.total_epochs=1 $@ \
        trainer.default_local_dir=/scratch/keane/human_behaviour/harpo_unnormalized_adv