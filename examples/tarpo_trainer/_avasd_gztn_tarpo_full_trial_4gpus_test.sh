...
# trainer.resume_from_path=/scratch/keane/human_behaviour/harpo_unnormalized_adv/global_step_300
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        data.val_files=/scratch/jadali85/autism/av-asd/test_av_asd_promptsmultilabel.jsonl \
        ...
        trainer.experiment_name='avasd_harpo_unnormed' \
        ...
        trainer.validation_data_dir=/scratch/keane/human_behaviour/harpo_unnormalized_adv/avasd_test \
        trainer.test_freq=1 \
