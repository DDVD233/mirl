...
# /scratch/keane/human_behaviour/human_behaviour_data/no_vid_test_processed_iemocap_ground_truth.jsonl 
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.resume_from_path=/scratch/keane/human_behaviour/naive_density/global_step_150 \
        trainer.val_only=True \
        trainer.validation_data_dir=/scratch/keane/human_behaviour/naive_density/global_step_150_test \
        trainer.test_freq=1 \
        trainer.total_epochs=1 $@ \
        trainer.default_local_dir=/scratch/keane/human_behaviour/naive_density/