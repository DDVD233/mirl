...
# originally prompt length, response length, max model len is 2048, 2048, 8192 
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='harpo_task_only_global_step_350_test' \
        trainer.n_gpus_per_node=4 \
        trainer.nnodes=1 \
        trainer.save_freq=999999 \
        trainer.val_before_train=True \
        trainer.resume_mode=resume_path \
        trainer.resume_from_path=/scratch/keane/human_behaviour/tarpo_iter_22_no_resp_no_hierarchy_mixtures_densities_ema_original/global_step_350 \
        trainer.val_only=True \
        trainer.validation_data_dir=/scratch/keane/human_behaviour/tarpo_iter_22_no_resp_no_hierarchy_mixtures_densities_ema_original/global_step_350_test \
        trainer.test_freq=1 \
