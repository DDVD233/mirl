...
# originally prompt length, response length, max model len is 2048, 2048, 8192 
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='test_tarpo_iter_20_no_resp_corrected_hierarchy_mixtures_densities_ema_original' \
        trainer.n_gpus_per_node=4 \
        trainer.nnodes=1 \
        trainer.save_freq=50 \
        trainer.val_before_train=True \
        trainer.resume_mode=resume_path \
        trainer.resume_from_path=/scratch/keane/human_behaviour/tarpo_iter_20_no_resp_corrected_hierarchy_mixtures_densities_ema_original/global_step_425 \
        trainer.val_only=True \
        trainer.validation_data_dir=/scratch/keane/human_behaviour/tarpo_iter_20_no_resp_corrected_hierarchy_mixtures_densities_ema_original/global_step_425_test \
        trainer.test_freq=1 \
        trainer.total_epochs=1 $@ \
        trainer.default_local_dir=/scratch/keane/human_behaviour/tarpo_iter_20_no_resp_corrected_hierarchy_mixtures_densities_ema_original/global_step_425