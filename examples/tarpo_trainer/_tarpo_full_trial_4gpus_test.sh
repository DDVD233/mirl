...
# originally prompt length, response length, max model len is 2048, 2048, 8192 
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='harpo_full_global_step_400_test' \
        ...
        trainer.validation_data_dir=/scratch/keane/human_behaviour/HARPO_Hier_Ema_Rerun/global_step_400_test \
        trainer.test_freq=1 \
