...
# data.train_files=/scratch/keane/human_behaviour_data/final_v8_train_cleaned_2.jsonl \
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='harpo_unnormed_v2' \
        trainer.n_gpus_per_node=4 \
        trainer.nnodes=1 \
        trainer.save_freq=5 \
        trainer.val_before_train=False \
        trainer.val_only=False \
        trainer.validation_data_dir=/scratch/keane/hb_atlas_models/harpo_unnormed_v2 \
        trainer.test_freq=99999 \
        trainer.total_epochs=5 \
        trainer.advantage_save_dir=/scratch/keane/hb_atlas_models/harpo_unnormed_v2/advantages \
        trainer.advantage_plot_freq=15 $@ \
        trainer.default_local_dir=/scratch/keane/hb_atlas_models/harpo_unnormed_v2