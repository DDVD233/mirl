...
# try also last_train_intentqa_rha.jsonl ; last_train_siq2_rha.jsonl
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='intentqa_only' \
        trainer.n_gpus_per_node=2 \
        trainer.nnodes=1 \
        trainer.save_freq=500 \
        trainer.val_before_train=False \
        trainer.val_only=False \
        trainer.validation_data_dir=/scratch/keane/human_behaviour/intentqa \
        trainer.test_freq=500 \
        trainer.total_epochs=1 $@ \
        trainer.default_local_dir=/scratch/keane/human_behaviour/intentqa