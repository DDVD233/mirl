...
# AVASD
# INPUT_JSONL="/scratch/keane/human_behaviour_data/avasd_zeroshot_dataset/test_av_asd_promptsmultilabel.jsonl"


    python3 -m verl.trainer.main_ppo \
        algorithm.adv_estimator=tarpo \
        data.train_files=/scratch/keane/human_behaviour_data/final_v8_train_cleaned_2.jsonl \
        data.val_files=/scratch/keane/human_behaviour_data/avasd_zeroshot_dataset/test_av_asd_promptsmultilabel.jsonl \
        ...
        trainer.experiment_name='avasd_harpo_v3' \
        ...
        trainer.validation_data_dir=/scratch/keane/hb_atlas_models/harpo_v3/global_step_450/avasd_test \
        trainer.test_freq=1 \
