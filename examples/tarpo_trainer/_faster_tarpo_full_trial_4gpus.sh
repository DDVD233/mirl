...
# originally prompt length, response length, max model len is 2048, 2048, 8192 
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.validation_data_dir=/scratch/keane/human_behaviour/fast_tarpo_iter_17_corrected_hierarchy_mixtures_densities_ema_original \
        trainer.test_freq=50 \
        trainer.total_epochs=5 \
        trainer.advantage_save_dir=/scratch/keane/human_behaviour/fast_tarpo_iter_17_corrected_hierarchy_mixtures_densities_ema_original/advantages \
        trainer.advantage_plot_freq=15 $@ \
        trainer.default_local_dir=/scratch/keane/human_behaviour/fast_tarpo_iter_17_corrected_hierarchy_mixtures_densities_ema_original