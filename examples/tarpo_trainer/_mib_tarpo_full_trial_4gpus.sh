...
# And also the micro batch size per gpu to 8
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='harpo_no_ema_v2' \
        trainer.n_gpus_per_node=4 \
        trainer.nnodes=1 \
        trainer.save_freq=5 \
        trainer.val_before_train=False \
        trainer.val_only=False \
        trainer.validation_data_dir=/scratch/keane/hb_atlas_models/harpo_no_ema_v2 \
        trainer.resume_mode=resume_path \
        trainer.resume_from_path=/scratch/keane/hb_atlas_models/harpo_no_ema/global_step_350 \
        trainer.test_freq=99999 \
        trainer.total_epochs=5 \
        trainer.advantage_save_dir=/scratch/keane/hb_atlas_models/harpo_no_ema_v2/advantages \
        trainer.advantage_plot_freq=15 $@ \
        trainer.default_local_dir=/scratch/keane/hb_atlas_models/harpo_no_ema_v2