...
# data.train_files=/scratch/keane/human_behaviour_data/final_v8_train_cleaned_2.jsonl \
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        data.max_prompt_length=2046 \
        data.max_response_length=2046 \
        ...
        trainer.experiment_name='r_plus_plus_mib_tarpo_iter_16_mixtures_densities_ema_original' \
        trainer.n_gpus_per_node=4 \
        trainer.nnodes=1 \
        trainer.save_freq=50 \
        trainer.val_before_train=False \
        trainer.val_only=False \
        trainer.validation_data_dir=/scratch/keane/hb_atlas_models/r_plus_plus_tarpo_iter_16_mixtures_densities_ema_original \
        trainer.test_freq=50 \
        trainer.total_epochs=5 \
        trainer.advantage_save_dir=/scratch/keane/hb_atlas_models/r_plus_plus_tarpo_iter_16_mixtures_densities_ema_original/advantages \
        trainer.advantage_plot_freq=15 $@ \
        trainer.default_local_dir=/scratch/keane/hb_atlas_models/r_plus_plus_tarpo_iter_16_mixtures_densities_ema_original