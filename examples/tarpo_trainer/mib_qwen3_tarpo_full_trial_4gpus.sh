...
# rla_fulltemp_test_daicwoz.jsonl 
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='mib_tarpo_iter_15_mixtures_densities_ema_original' \
        trainer.n_gpus_per_node=4 \
        trainer.nnodes=1 \
        trainer.save_freq=10 \
        trainer.val_before_train=False \
        trainer.val_only=False \
        trainer.validation_data_dir=/scratch/keane/hb_atlas_models/tarpo_iter_15_mixtures_densities_ema_original \
        trainer.test_freq=10 \
        trainer.total_epochs=5 \
        trainer.advantage_save_dir=/scratch/keane/hb_atlas_models/tarpo_iter_15_mixtures_densities_ema_original/advantages \
        trainer.advantage_plot_freq=10 $@ \
        trainer.default_local_dir=/scratch/keane/hb_atlas_models/tarpo_iter_15_mixtures_densities_ema_original