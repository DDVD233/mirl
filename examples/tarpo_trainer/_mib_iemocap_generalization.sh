...
# trainer.resume_from_path=/scratch/keane/human_behaviour/dapo_enhanced_harpo/global_step_350
# trainer.resume_from_path=/scratch/keane/human_behaviour/harpo_unnormalized_adv/global_step_300

## IEMOCAP
# INPUT_JSONL="/scratch/keane/human_behaviour_data/no_vid_test_processed_iemocap_ground_truth.jsonl"

    python3 -m verl.trainer.main_ppo \
        algorithm.adv_estimator=tarpo \
        data.train_files=/scratch/keane/human_behaviour_data/final_v8_train_cleaned_2.jsonl \
        data.val_files=/scratch/keane/human_behaviour_data/no_vid_test_processed_iemocap_ground_truth.jsonl \
        ...
        trainer.experiment_name='iemocap_harpo_harpo_v3' \
        trainer.n_gpus_per_node=4 \
        trainer.nnodes=1 \
        trainer.save_freq=999999 \
        trainer.val_before_train=True \
        trainer.resume_mode=resume_path \
        trainer.resume_from_path=/scratch/keane/hb_atlas_models/harpo_v3/global_step_450 \
        trainer.val_only=True \
        trainer.validation_data_dir=/scratch/keane/hb_atlas_models/harpo_v3/global_step_450/global_step_450_iemocap_test \
        trainer.test_freq=1 \
        trainer.total_epochs=1 $@ \
        trainer.default_local_dir=/scratch/keane/hb_atlas_models/harpo_v3/global_step_450