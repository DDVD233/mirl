...
# Mirrors run_qwen3_vl-8b-megatron_date.sh but for google/gemma-3-4b-it.
# Same image (verlai/verl:vllm011.2.dev3) + Megatron + mbridge path that works
# coherently for the qwen3-vl run.
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    trainer.experiment_name='gemma3_4b_dapo_split_date_megatron' \
