...
train_path="$HOME/scratch/raofu/3DHaptic/annotation_verl_split_participant_train.json"
test_path="$HOME/scratch/raofu/3DHaptic/annotation_verl_split_participant_test_mini.json"
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    trainer.experiment_name='gemma4_e4b_dapo_split_participant' \
