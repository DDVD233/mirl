...
# CLS_JSON="/scratch/keane/hb_atlas_models/rloo_mib_baseline2/global_step_350_test/cls_val_generations_350.json"
# LLM_JSON="/scratch/keane/hb_atlas_models/rloo_mib_baseline2/global_step_350_test/full_test_or_val_generation_outputs/step_350_llm_grading_results.json"

LABEL_MAP="/home/keaneong/human-behavior/verl/sft/label_maps/unified_label_map.json"
OUTPUT_JSON="/home/keaneong/human-behavior/verl/examples/bootstrap/v2_HARPO_step_400_test_eval_metrics_bootstrap.json"
N_BOOT=100000
...
WANDB_RUN_NAME="v2_harpo_test_step_400_bootstrap"          # optional run name, e.g. "grpo_step600_bootstrap"
WANDB_ARTIFACT_NAME="v2_harpo_test_step_400_bootstrap_eval"
# ─────────────────────────────────────────────────────────────────────────────
