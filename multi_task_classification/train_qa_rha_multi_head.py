...
from models.rha_addqa_multi_head_omni_classifier import MultiHeadOmniClassifier
from trainer.rha_qa_multi_head_omni_classifier_trainer import QARHAMultiHeadOmniClassifierAccelerateTrainer
...
def main():
    ...
    trainer = QARHAMultiHeadOmniClassifierAccelerateTrainer(
