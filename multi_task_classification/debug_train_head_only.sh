...
accelerate launch --config_file configs/accelerate_config_qwen.yaml train.py \
    ...
    --save_checkpoint_dir "/scratch/keane/human_behaviour/3_debug_head_only_training" \
    --load_checkpoint_path "/scratch/keane/human_behaviour/3_debug_head_only_training/step_3" \
