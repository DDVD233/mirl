...
def parse_parameters():
    ...
    parser.add_argument('--rla_stage', type=str, choices=['base_only','residual_only','joint', 'residual_and_head'],
...
def main():
    ...
    trainer = RHAMultiHeadOmniClassifierAccelerateTrainer(
    ...
    if MODE == 'train':
        ...
        stats = profiler.profile_forward_cost(num_batches=500, description="rha_profile")
        print(stats)
    else:
