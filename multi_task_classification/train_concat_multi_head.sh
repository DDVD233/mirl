...
accelerate launch --config_file configs/accelerate_config_qwen.yaml train_concat_multi_head.py \
    --mode train \
    ...
    --load_checkpoint_path "/scratch/keane/human_behaviour/cat_v5_multi_head_lora_training/step_15000" \
