...
from models.addqa_multi_head_omni_classifier import MultiHeadOmniClassifier
from trainer.addqa_multi_head_omni_classifier_trainer import MultiHeadOmniClassifierAccelerateTrainer
...
def main():
    ...
    trainer = MultiHeadOmniClassifierAccelerateTrainer(
