...
accelerate launch --config_file configs/accelerate_config_qwen.yaml addqa_train_multi_head.py \
    ...
    --load_checkpoint_path "/scratch/keane/human_behaviour/3_freeze_base_qa_multi_task_model/step_12000" \
    --save_every_n_epochs 1 \
    --save_every_n_steps 2000 \
    --save_checkpoint_dir "/scratch/keane/human_behaviour/3_freeze_base_qa_multi_task_model/" \
    --validation_result_dir "/scratch/keane/human_behaviour/3_freeze_base_qa_multi_task_model/test_results" \
    --validate_every_n_epochs 1 \
    --validate_every_n_steps 999999 \
    --early_stopping_patience 999999 \
    --project "2_freeze-base-qa-omni-classifier-multi-task-lora" \
