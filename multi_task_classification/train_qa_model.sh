...
accelerate launch --config_file configs/accelerate_config_qwen.yaml addqa_train_multi_head.py \
    ...
    --lr 1e-4 \
    --epochs 4 \
    --train_file "/scratch/keane/human_behaviour/human_behaviour_data/0.001_qa_train.jsonl" \
    ...
    --save_every_n_steps 4500 \
    --save_checkpoint_dir "/scratch/keane/human_behaviour/qa_multi_task_model" \
    --validation_result_dir "/scratch/keane/human_behaviour/qa_multi_task_model/test_results" \
