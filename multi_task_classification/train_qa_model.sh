...
accelerate launch --config_file configs/accelerate_config_qwen.yaml addqa_train_multi_head.py \
    ...
    --save_checkpoint_dir "/scratch/keane/human_behaviour/freeze_base_qa_multi_task_model/debug/" \
    --validation_result_dir "/scratch/keane/human_behaviour/freeze_base_qa_multi_task_model/debug/test_results" \
