...
class MultiHeadOmniClassifierAccelerateTrainer:
    ...
    def test(self):
        ...
        # No optimizer needed for test/eval — prepare model and dataloaders only.
        # Skipping optimizer registration means accelerator.load_state() won't attempt
        # to restore optimizer state, avoiding mismatches with checkpoints saved under
        # a different training strategy (e.g. LoRA vs full-param).
