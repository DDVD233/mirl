...
accelerate launch --config_file configs/accelerate_config_qwen.yaml train_rha_multi_head.py \
  --mode train \
  ...
  --validation_result_dir "/scratch/keane/human_behaviour/debug_rha/validation_results" \
  ...
  --project "debug-rha-omni-classifier-multi-head-lora" \
