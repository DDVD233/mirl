...
SYSTEM_PROMPT = (
    ...
    "First reason inside <think>...</think> tags. Keep your reasoning under "
    "500 words. Commit to your reasoning — do not waver, backtrack, or use "
    "hedging phrases like \"wait\", \"actually\", \"on second thought\", or "
    "\"hmm\". Give your best answer directly.\n\n"
    "Then output the final answer in the form "
