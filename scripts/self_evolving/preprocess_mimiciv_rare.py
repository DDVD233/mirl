...
SYSTEM_PROMPT = (
    ...
    "Think through the case briefly, then give your final answer. Keep your "
    "reasoning under 500 words. Commit to your reasoning — do not waver, "
    "backtrack, or use hedging phrases like \"wait\", \"actually\", \"on "
    "second thought\", or \"hmm\". Give your best answer directly.\n\n"
    "Output the final answer in the form "
    "\\boxed{ICD-10 CODE: Diagnosis name} (e.g. "
    "\\boxed{E70.0: Classical phenylketonuria}). The boxed answer is "
