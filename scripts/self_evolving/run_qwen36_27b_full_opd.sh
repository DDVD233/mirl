...
#
# Proposer + judge + teacher all point at the same 397B endpoint by default;
# override any of API_BASE / TEACHER_URL via env to split them.
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-mimiciv_rare_qwen36_27b_full_opd_qwen397b}"
