...
# Student override (e.g. Qwen/Qwen3.5-9B needs USE_REMOVE_PADDING=False ATTN_SDPA=1
# ROLLOUT_TP=2: head_dim=256 breaks FA varlen; see run_qwen35_9b_selfimprove.sh).
