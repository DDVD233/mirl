...
def main():
    ...
    # Captions follow the wording of the 2026-09-11 ML4H-synced draft (method renamed RRIMed).
    cap_main = (r"HealthBench Professional accuracy using the official length-adjusted rubric score on all 525 tasks "
                ...
                r"base model and grading protocol; within a setting, \emph{Fixed prompt} and \emph{RRIMed} share "
