...
ERROR_LOG_FILE = "/home/keaneong/human-behavior/verl/sft/failed_ext_paths_log/adapter_utils_errors.txt"

def log_problem(where: str, detail: str, extra: dict | None = None) -> None:
    """Append problematic file info to a log file. Never throws."""
    if extra is None:
        extra = {}
    try:
        os.makedirs(os.path.dirname(ERROR_LOG_FILE), exist_ok=True)
        with open(ERROR_LOG_FILE, "a") as f:
            f.write(f"[BAM:{where}] {detail} | extra={extra}\n")
